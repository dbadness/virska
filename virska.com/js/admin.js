$(document).ready(function() {
	...
	$.ajax({
		...
		success: function(response) {
		  ...
		  var plot1 = $.jqplot('idodGrowth', [new_data], {
		      title:'Incremental Day Over Day Growth',
		      axes:{
		        xaxis:{
	...
	$.ajax({
		...
		success: function(response) {
		  ...
		  var plot1 = $.jqplot('adodGrowth', [new_data], {
		      title:'Aggregate Day Over Day Growth',
		      axes:{
		        xaxis:{
		          renderer:$.jqplot.DateAxisRenderer,
		          tickOptions:{
